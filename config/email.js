...
var invoiceTemplate = transporter.templateSender({
  ...
  text: "This is the text version from Four*Limes. Hi {{firstName}}, thanks for your order. Your order number is {{ order_id }}. In case you need a reminder, the details for your order are: Date ordered: {{ date }}. Contact Person for delivery: {{ firstName }} {{ lastName }}. Delivery Address: {{ buildingNumber }} {{ addressLine1 }}, {{ addressLine3 }}, {{ postcode }}. Contact Person's Phone Number: {{ contact_ph }}. Order total: £{{ grandTotal }}. Steve, your delivery driver, will be in touch in the next business day to personally organise delivery with you. If you have any issues or you havn't heard from Steve, then call us on 07508 727482 or drop us a line at care@fourlimes.co.uk. FourLimes ltd - London, Uk",
  html: "<head><style>.body{background-color: #E4DFDA}h1{color: #4281a4}</style></head><body class='body'><h1>Four*Limes</h1><br><h3>Hi {{firstName}}, thanks for your order.</h3><h3>Your order number is {{ order_id }}</h3><p>In case you need a reminder, the details for your order are: </p><p> Date ordered: {{ date }}</p><p>Contact Person for delivery: {{ firstName }} {{ lastName }}</p><p>Delivery Address:</p><p>{{ buildingNumber }} {{ addressLine1 }}</p><p>{{ addressLine3 }}</p><p>{{ postcode }}</p><p>Contact Person's Phone Number: {{ contact_ph }}</p><p> Order total: £{{ grandTotal }}</p><p>Steve, your delivery driver, will be in touch in the next business day to personally organise delivery with you.</p><h5>If you have any issues or you havn't heard from Steve, then call us on 07508 727482 or drop us a line at care@fourlimes.co.uk</h5><br><br><p>FourLimes ltd - London, UK</p></body>"
